...
$result = mysqli_query($conn,"SELECT * FROM customer_data");
...
<td><a href="customerinfo.php?id=<?php echo $row['id'];?>" data-toggle="tooltip" data-placement="top" title="VIEW DATA"><i class="fa fa-file" aria-hidden="true"></i></a> </td>
</tr>
<?php
}
echo "</table>";
